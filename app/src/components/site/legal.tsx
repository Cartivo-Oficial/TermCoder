    ...
    <div className="flex min-h-full flex-col">
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-3xl px-6 py-16">
          <div className="font-mono text-[11px] uppercase tracking-[0.16em] text-muted-foreground">legal</div>
          ...
          <p className="mt-6 font-mono text-[11.5px] text-muted-foreground">Last updated: {UPDATED}</p>
        </div>
      </section>
