...
export const TUI_COMMANDS: TuiCommand[] = [
  ...
  { name: "recipes", desc: "List saved recipes (dev workflows & study lessons)" },
  { name: "recipe", arg: "<name>", desc: "Run a saved recipe — execute its steps in order" },
  { name: "connectors", desc: "Browse one-click MCP connectors (GitHub, filesystem, …)" },
  { name: "mcp", arg: "[add <id> …]", desc: "List MCP servers, or add one from the connector catalog" },
